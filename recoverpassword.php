...
if(isset($_POST['btnsubmit']))
{
	...
	$sql = "UPDATE student  SET student_password='$encpass' where student_id='$_POST[login_id]'";
	...
	{
		echo "<script>alert('You have entered invalid details. Please try again...');</script>";
	}
}
?>
<br>
