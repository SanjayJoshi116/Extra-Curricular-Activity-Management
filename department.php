...
{	
	...
	{
		$sql="UPDATE department SET department='$_POST[department]', department_detail='$_POST[department_detail]', department_status='$_POST[department_status]' WHERE department_id='$_GET[editid]'";
